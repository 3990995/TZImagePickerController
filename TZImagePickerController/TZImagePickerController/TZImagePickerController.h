...
#define DEVICE_IS_IPHONEXLATER   (DEVICE_IS_IPHONEX || DEVICE_IS_IPHONEXR || DEVICE_IS_IPHONEXSMax)
...
#define DEVICE_IS_IPHONEXSMax    ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1242, 2688), [[UIScreen mainScreen] currentMode].size) : NO)
